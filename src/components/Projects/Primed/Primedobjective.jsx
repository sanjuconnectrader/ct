 ...
 * - Montserrat Light
 */
export default function Primedobjective({
  title = "Objectives",
  ...
  return (
    <section className="Primedobjective" aria-labelledby="mo-title">
      <div className="Primedobjective__wrap">
        <div className="Primedobjective__header">
          <h2 id="mo-title" className="Primedobjective__title">{title}</h2>
          <p className="Primedobjective__lead">{intro}</p>
        </div>

        <div className="Primedobjective__grid" role="list">
          {items.map((it, idx) => (
            <article 
              className="Primedobjective__card" 
              role="listitem" 
              key={idx}
              style={{ animationDelay: `${idx * 0.15 + 0.4}s` }}
            >
              <div className="Primedobjective__cardInner">
                <div className="Primedobjective__iconWrapper">
                  <div className="Primedobjective__icon" aria-hidden="true">
                    {it.icon === "pen" && (
                  ...
                  <div className="Primedobjective__iconHover"></div>
                </div>

                <div className="Primedobjective__content">
                  <h3 className="Primedobjective__heading">{it.heading}</h3>
                  <p className="Primedobjective__body">{it.body}</p>
                </div>
                
                <div className="Primedobjective__cardDecoration"></div>
              </div>
            </article>
          ))}
        </div>
